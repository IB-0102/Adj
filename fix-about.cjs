const fs = require('fs');
let code = fs.readFileSync('src/components/portfolio/About.tsx', 'utf8');

const newCode = `import { motion } from 'motion/react';
...
fs.writeFileSync('src/components/portfolio/About.tsx', newCode);
